//5) Listázza ki azoknak a csapatoknak a nevét, amik az előző alkalom óta helyezésük nem változott!
...
try {
 ...
 const szurtAdat=await collection.find({Valtozas:0}).toArray(); 
